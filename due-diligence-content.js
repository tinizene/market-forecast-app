          ...
          articles: [
            {
              ...
              body: [
                ...
                'Currency strength and correlation context — seeing how a currency is performing against several others at once, not just one pair — helps separate "this currency is genuinely strong" from "this one pair moved because of the other currency in it." Our own FX Intelligence Desk (linked from Learn and the main Markets page) builds this view directly from that day’s report; treat it the same way you’d treat any other source in this list — useful context, sourced and dated, not a signal to act on without your own check.',
