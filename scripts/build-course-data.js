...
const TRACKS = [
  ...
  },
  {
    ...
    trackKey: null,
    // Generated by scripts/build-stocks-svgs.js rather than hand-authored, so the
    // figures inside the diagrams come from the same arithmetic as the lesson text.
    svgKey: 'SCERE_STOCKS_SVGS',
    svgFile: 'stocks-svgs.js',
...
function loadBundles() {
  ...
  for (const t of TRACKS) {
    for (const file of [t.file, t.rewriteFile, t.svgFile].filter(Boolean)) {
